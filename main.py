...
p7 = Product(**{"product": "id1", "category": "film", "subCategory": "education", "price": 100, "size": 10})
p8 = Product(**{"product": "id1", "category": "film", "subCategory": "education", "price": 200, "size": 10})
...
product_service.add(p7)
product_service.add(p8)
...
query5 = Query(filters={}, groupedBy="subCategory")
...
print(product_service.query(query5))
